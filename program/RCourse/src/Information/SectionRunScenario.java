...
public class SectionRunScenario {
	...
	public SectionRunScenario()
	{
		...
		scenario[4] = new MoveBlock(RED_COLOR_ID,false, true);
		scenario[5] = new MoveArea(2); //左手前まで移動
		scenario[6] = new MoveBlock(BLUE_COLOR_ID,true, true);
		scenario[7] = new MoveArea(3); //左奥まで移動
		scenario[8] = new MoveBlock(YELLOW_COLOR_ID,false, true);
		scenario[9] = new MoveArea(4); //右奥まで移動
		scenario[10] = new MoveBlock(GREEN_COLOR_ID,true, true);
		...
		scenario[15] = new MoveBlock(YELLOW_COLOR_ID,false, true);
		scenario[16] = new MoveArea(2); //左手前まで移動
		scenario[17] = new MoveBlock(GREEN_COLOR_ID,true, true);
		scenario[18] = new MoveArea(3); //左奥まで移動
		scenario[19] = new MoveBlock(BLUE_COLOR_ID,false, true);
		scenario[20] = new MoveArea(4); //右奥まで移動
		scenario[21] = new MoveBlock(RED_COLOR_ID,true, true);
